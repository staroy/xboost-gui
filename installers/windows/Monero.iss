...
; See LICENSE
#define GuiVersion GetFileVersion("bin\xboost-wallet-gui.exe")
...
; Monero daemon
Source: "bin\xboostd.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "bin\extras\xboost-blockchain-export.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\xboost-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\xboost-blockchain-mark-spent-outputs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\xboost-blockchain-usage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\xboost-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\xboost-blockchain-ancestry.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\xboost-blockchain-depth.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\xboost-blockchain-prune-known-spent-data.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\xboost-blockchain-prune.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\xboost-blockchain-stats.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\xboost-gen-ssl-cert.exe"; DestDir: "{app}"; Flags: ignoreversion
...
begin
  if CurStep = ssPostInstall then begin
    ...
    SetArrayLength(s, 3);
    s[0] := 'REM Execute the Xboost daemon and then stay with window open after it exits';
    s[1] := '"' + ExpandConstant('{app}\xboostd.exe') + '" ' + DaemonFlags('');
    s[2] := 'PAUSE';
...
Name: "{group}\GUI Wallet"; Filename: "{app}\xboost-wallet-gui.exe";
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\monero-gui-wallet-guide.pdf"; IconFilename: "{app}\xboost-wallet-gui.exe"
...
Name: "{group}\Utilities\Monero Daemon"; Filename: "{app}\xboostd.exe"; Parameters: {code:DaemonFlags}
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\xboost-wallet-cli.exe"; WorkingDir: "{userdocs}\Xboost\wallets"
...
Root: HKCR; Subkey: "xboost"; ValueType: "string"; ValueData: "URL:Monero Payment Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "xboost"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "xboost\DefaultIcon"; ValueType: "string"; ValueData: "{app}\monero-wallet-gui.exe,0"
Root: HKCR; Subkey: "xboost\shell\open\command"; ValueType: "string"; ValueData: """{app}\monero-wallet-gui.exe"" ""%1"""
...
Root: HKCR; Subkey: "xboostseed"; ValueType: "string"; ValueData: "URL:Monero Seed Node Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "xboostseed"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "xboostseed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\xboost-wallet-gui.exe,0"
Root: HKCR; Subkey: "xboostseed\shell\open\command"; ValueType: "string"; ValueData: """{app}\xboost-wallet-gui.exe"" ""%1"""
